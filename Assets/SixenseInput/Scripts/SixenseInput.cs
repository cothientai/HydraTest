...
public class SixenseInput : MonoBehaviour
{
	...
	public class Controller
	{
		...
		/// </summary>
		public SixenseHands Hand { get { return ( ( m_Hand == SixenseHands.UNKNOWN ) ? m_HandBind : m_Hand ); } } // ?: conditional operator
		...
		internal void Update( ref SixensePlugin.sixenseControllerData cd )
		{
			...
			{
				m_Buttons |= SixenseButtons.TRIGGER; //Equivalent of m_Buttons = m_Buttons | SixenseButtons.TRIGGER
			}
		}
